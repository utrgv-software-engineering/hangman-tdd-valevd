...
void main() {
  ...
  group("Test Scoring Logic", () {
    ...
    test(
      "after a single incorrect guess",
      () {
        String word = 'banana';
        final hangmanGame = HangmanGame(word);
        //Guess one incorrect letter
    ...
    test(
      "after multiple correct guesses",
      () {
        String word = 'banana';
        final hangmanGame = HangmanGame(word);
    ...
    test(
      "after some correct and some incorrect guesses",
      () {
        String word = 'banana';
        final hangmanGame = HangmanGame(word);
        //Guess 2 correct
